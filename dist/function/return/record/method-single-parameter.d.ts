...
export default function MethodSingleParameter<Argument extends object, Type extends MapSingle<Argument>>({ value, argument, }: MethodSingleArgument<Argument, Type>): O.Pick<Infer<Type>, keyof Argument>;
