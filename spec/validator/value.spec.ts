...
//
//         let property = ValueAll.Parameter<string>(validator,
...
//         };
//
//         let property = ValueAll.Parameter/*<unknown, string|number>*/(validator,(v)=>And(v), MessageMap);
//
//             let and = property({});
//
//             expect<boolean>(and.valid).toBe(false);
...
//             };
//
//             let property = ValueAll.Parameter/*<unknown, string|number>*/(validator,(v)=>Or(v), MessageMap);
//
//             let or = property({});
