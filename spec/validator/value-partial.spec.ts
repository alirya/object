...
describe("compiler compatibility", function() {
    ...
    describe("implicit partial", function() {
        ...
        let property = Value.Parameter(validator, (v)=>And(v), MessageMap);
    ...
    describe("explicit complete", function() {
        ...
        let property = Value.Parameter<string, string, {name : string, address : string}, typeof validator>(validator,
            And,
