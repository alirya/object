...
it('plain', () => {
    ...
    const object = PropertyLazyDynamicParameters(source, 'data', () =>'string', true, true);
...
describe('class', () => {
    ...
    it('implement', () => {
        ...
        const type : Interface = PropertyLazyDynamicParameters(source, 'data', () =>'string', true, true);
...
describe('not exists', () => {
    ...
    it('multi', () => {
        ...
        const object = PropertyLazyDynamicParameters(source, 'value', () =>'string', true, true);
