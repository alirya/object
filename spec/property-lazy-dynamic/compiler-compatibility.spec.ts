...
it('plain', () => {
    ...
    let object = PropertyLazyDynamicParameters(source, 'data', () =>'string', true, true);
...
describe('class', () => {
    ...
    it('implement', () => {
        ...
        let type : Interface = PropertyLazyDynamicParameters(source, 'data', () =>'string', true, true);
...
describe('not exists', () => {
    ...
    it('multi', () => {
        ...
        let object = PropertyLazyDynamicParameters(source, 'value', () =>'string', true, true);
